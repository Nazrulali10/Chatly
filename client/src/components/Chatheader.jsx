...
export default function Chatheader({selectedUser,setselectedUser,onlineUsers}){
    return(
        <div className="flex h-18 w-full border-b-grey-500 px-5 items-center gap-2">
            <button className="text-white hover:text-amber-500 cursor-pointer" onClick={()=>{setselectedUser(null)}}><ChevronLeft/></button>
            ...
            <p className="text-normal text-white">{selectedUser.fullname}</p>
