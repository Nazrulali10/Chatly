...
export default function Profilepage({
  ...
  return (
      ...
      <div className="bg-sky-500 flex h-screen w-full items-center px-10 md:p-0 md:justify-center md:items-center">
        <div className="flex flex-col bg-indigo-950  h-120 w-120 p-5 justify-center items-center">
          <h1 className="text-3xl md:text-4xl text-white font-bold">Profile</h1>
          <div className="mt-4 relative ">
            <img
              className="border rounded-full h-50 w-50"
          ...
          <label className="text-white font-semibold text-sm">
            ...
            <input
              type="text"
              className="w-80 border ml-2 bordee-1 font-semibold border-md px-3 py-2 text-white border-sky-500 mb-4 text-xs"
          ...
          <label className="text-white text-sm font-semibold">
            ...
            <input
              type="text"
              className="w-80 border ml-2 bordee-1 font-semibold border-md px-3 py-2 text-white border-sky-500 text-xs"
